...
class NCA_REAL(nn.Module):
    ...
    def forward(self, input_state:torch.Tensor, num_steps:int, return_frames = False, dropout:float=0.2) -> torch.Tensor:
        ...
        for _ in range(num_steps):
            ...
            #input_state[..., self.state_structure.estimation_channels, :, :] = input_state[..., self.state_structure.estimation_channels, :, :] * in_contact_mask + constant_values * not_in_contact_mask
